...
public class BikeRentalCustomerClient {
    ...
    private static final int GET_AVAIL_BIKES = 1;
        ...
        try {
            ...
            while (command != 0) {
                ...
                if (command == 0) {
                    ...
                    ResultSet result1 = statement1.executeQuery("select * from Rental where checked_out = false"); // Returns in result all bikes on rental table available for rental
                    ...
                    ; // no updates/insert necessary for this if we assume we will always keep items in stock
